...
namespace Problem5
{
  class Problem5
  {
    public static IEnumerable<int> findOddsMultOfFive(IEnumerable<int> input1, IEnumerable<int> input2)
    {
      ...
      result = input1.Union(input2).Where(x => x % 5 == 0).Where(x => x % 2 != 0);
      return result;
    }
  }
  ...
  class Program
  {
    static void Main(string[] args)
    {
      ...
      List<int> list1 = numbers1.OfType<int>().ToList();
      List<int> list2 = numbers2.OfType<int>().ToList();

      var answer = Problem5.findOddsMultOfFive(list1, list2);
